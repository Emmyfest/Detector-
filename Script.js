document.addEventListener('DOMContentLoaded', function() {
    ...
    uploadForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const API_KEY = '6qTADYbzDR7hVfvOTvmX9vQ6qEudZNMGoQ9rXQEDv70Ox0vieK';
            ...
            if (response.ok) {
                ...
                // For demonstration purposes, since the API is returning 404,
                // we'll show a more helpful error message
                showError(`API request failed (${response.status}): The Kindwise API endpoint might be incorrect or not accessible from your current domain. Please check your API configuration.`);
            ...
            hideLoading();
            showError(`Network error: ${error.message}. This might be due to CORS restrictions when accessing the API from your domain.`);
